...
namespace AuthServer
{
    ...
    {
        public static List<IdentityServer4.Test.TestUser> Users
        {
            get
            {
                var address = new
        ...
        // resource owner flow
            ...
            new Client
            {
                ...
                AllowedScopes = {IdentityServerConstants.StandardScopes.OpenId, IdentityServerConstants.StandardScopes.Profile,"jobsapi.scope" },
                RequirePkce = true,
